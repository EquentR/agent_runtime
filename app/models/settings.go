...
type AdminAuditEvent struct {
	...
	ActorEmail    string    `json:"actor_email" gorm:"type:varchar(255);index"`
...
type CustomLLMModel struct {
	ID               string    `json:"id" gorm:"type:varchar(128);primaryKey"`
	OwnerUserID      uint64    `json:"owner_user_id" gorm:"not null;index;uniqueIndex:idx_custom_model_owner_provider,priority:1"`
	ProviderID       string    `json:"provider_id" gorm:"type:varchar(128);not null;uniqueIndex:idx_custom_model_owner_provider,priority:2"`
