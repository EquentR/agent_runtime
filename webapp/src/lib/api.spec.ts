...
describe('normalizeConversationMessage', () => {
  ...
  it('coerces malformed mixed-shape payloads to safe conversation message values', () => {
    expect(
      normalizeConversationMessage({
        role: 'narrator',
        Content: { nested: true },
      ...
      tool_call_id: '42',
      reasoning_items: undefined,
      tool_calls: [{ id: '123', name: '', arguments: '' }],
    })
  })
